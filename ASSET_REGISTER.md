...
| --- | --- | ---: | --- | --- | --- | --- | --- |
| `about_me.jpg` | Phase 3 home identity rail, About profile, home/about Open Graph image | 162,377 B | Portrait supplied by the portfolio owner with the existing repository; creator and capture date undocumented | No embedded copyright field found | Approved by the portfolio owner for this portfolio; provenance record remains incomplete | Approved for portfolio use | Retain; obtain creator/date documentation before wider reuse |
...
| `portfolio.jpg` | Preserved version-two portfolio hero asset; no longer used by the Phase 4 portfolio index | 22,057 B | Embedded description: "Portfolio folder." | Embedded copyright: "Tom Hahn" | Permission not documented | Quarantined | Retain for recoverable baseline history only; do not use as portfolio evidence |
